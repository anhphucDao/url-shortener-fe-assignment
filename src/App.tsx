          ...
          <div className=" w-186">
            ...
            <div className="flex flex-row py-2">
              <div className="flex flex-row items-center px-1  w-152 border rounded-[10px] border-gray-400 divide-x divide-gray-400">
                <Link2
                  className="w-12 flex-none mr-1 my-2 hover:cursor-pointer"
                  onClick={async () => {
                    try {
              ...
              <button
                className="w-24.5 mx-auto rounded-[10px] bg-primary-500 font-bold font-sans text-white hover:shadow-[0px_0px_10px_rgba(0,0,0,0.5)] hover:cursor-pointer"
                disabled={isSubmited}
                onClick={() => {
                  handleSubmit()
                }}
