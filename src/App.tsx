        ...
        <div className="frame-5522__card">
          ...
          <div className="frame-5522__controls">
            <div className="frame-5522__input">
              ...
              <span className="frame-5522__input-text">Input the URL you want to shorten</span>
            </div>
            <button className="frame-5522__button" type="button">
              Shorten
            </button>
          </div>
        </div>
