  ...
  return (
    ...
    >
      <div className="w-90 h-100 bg-white flex flex-col items-center justify-center rounded-lg p-6 relative overflow-hidden">
        ...
        >
          <span className="material-icons scale-80" onClick={onClose}>
            close
          </span>
        </span>
        <div className="relative w-45 h-45 bg-gray-300 border-2 border-white flex items-center justify-center mb-4 border-10 border-gray-500 rounded-xl z-100">
          ...
          <span className="flex align-center justify-center bg-primary-500 text-white p-1 rounded-full absolute top-35 left-38 cursor-pointer hover:scale-120 transition-all ease-in delay-.3">
            <span className="material-icons flex align-center justify-center scale-80">
              download
            </span>
          </span>
        </div>
